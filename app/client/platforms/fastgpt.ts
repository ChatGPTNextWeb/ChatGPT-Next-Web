...
export class FastGPTApi implements LLMApi {
  ...
  async chat(options: FastGPTChatOptions) {
    ...
    const requestPayload = {
      chatId: modelConfig.id,
      stream: modelConfig.stream,
      detail: modelConfig.detail,
      variables: useChatStore.getState().currentSession().mask.fastgptVar,
      messages,
    };

    console.log("[FastGPT Request] openai payload: ", requestPayload);
