...
const jp: PartialLocaleType = {
  ...
  Settings: {
    ...
    Danger: {
      ...
      ClearChats: {
        Title: "すべてのチャットをクリア",
        SubTitle: "すべてのチャットがクリアされます",
        Action: "クリア",
        Confirm: "すべてのチャットをクリアしてもよろしいですか？",
      },      
      ExportMsg: {
        Title: "チャットをエクスポート",
        SubTitle: "チャットとその設定がJSONファイルにエクスポートされます",
        Action: "エクスポート",
        Confirm: "すべてのチャットをエクスポートしますか？",
      },
      ImportMsg: {
        Title: "チャットをインポート",
        SubTitle: "チャットとその設定がJSONファイルからインポートされます",
        Action: "インポート",
        Confirm: "すべてのチャットをインポートしますか？",
      },            
      ExportSettings: {
        Title: "すべての設定をエクスポート",
        SubTitle: "すべての設定がJSONファイルにエクスポートされます",
        Action: "エクスポート",
        Confirm: "すべてのグローバル設定をエクスポートしてもよろしいですか？",
      },
      ImportSettings: {
        Title: "すべての設定をインポート",
