  ...
  Settings: {
    ...
    Danger: {
      ...
      ClearChats: {
        ...
        SubTitle: "Toutes les conversations seront effacées",
        Action: "Effacer",
        Confirm: "Êtes-vous sûr de vouloir effacer toutes les conversations ?",
      },      
      ExportMsg: {
        Title: "Exporter toutes les conversations",
        SubTitle: "Les conversations et leurs paramètres seront exportés dans un fichier JSON",
        Action: "Exporter",
        Confirm: "Êtes-vous sûr de vouloir exporter toutes les conversations ?",
      },
      ImportMsg: {
        Title: "Importer toutes les conversations",
        SubTitle: "Les conversations et leurs paramètres seront importés à partir d'un fichier JSON",
        Action: "Importer",
        Confirm: "Êtes-vous sûr de vouloir importer toutes les conversations ?",
      },            
      ExportSettings: {
        Title: "Exporter tous les paramètres",
        SubTitle: "Tous les paramètres seront exportés dans un fichier JSON",
        Action: "Exporter",
        Confirm: "Êtes-vous sûr de vouloir exporter tous les paramètres de configuration globaux ?",
      },
      ImportSettings: {
        Title: "Importer tous les paramètres",
