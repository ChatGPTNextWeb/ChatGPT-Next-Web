  ...
  Settings: {
    ...
    Danger: {
      ...
      ClearChats: {
        ...
        SubTitle: "Semua percakapan akan dihapus",
        Action: "Hapus",
        Confirm: "Apakah Anda yakin ingin menghapus semua percakapan?",
      },      
      ExportMsg: {
        Title: "Ekspor Semua Percakapan",
        SubTitle: "Percakapan dan pengaturannya akan diekspor ke dalam file JSON",
        Action: "Ekspor",
        Confirm: "Apakah Anda yakin ingin mengekspor semua percakapan?",
      },
      ImportMsg: {
        Title: "Impor Semua Percakapan",
        SubTitle: "Percakapan dan pengaturannya akan diimpor dari file JSON",
        Action: "Impor",
        Confirm: "Apakah Anda yakin ingin mengimpor semua percakapan?",
      },            
      ExportSettings: {
        Title: "Ekspor Semua Pengaturan",
        SubTitle: "Semua pengaturan akan diekspor ke dalam file JSON",
        Action: "Ekspor",
        Confirm: "Apakah Anda yakin ingin mengekspor semua pengaturan konfigurasi global?",
      },
      ImportSettings: {
        Title: "Impor Semua Pengaturan",
