  ...
  Settings: {
    ...
    Danger: {
      ...
      ClearChats: {
        ...
        SubTitle: "All chats will be cleared",
        Action: "Clear",
        Confirm: "Are you sure you want to clear all chats?",
      },      
      ExportMsg: {
        Title: "Export Chats",
        SubTitle: "Chats and their settings will be exported into a JSON file",
        Action: "Export",
        Confirm: "Are you sure you want to export all chats?",
      },
      ImportMsg: {
        Title: "Import Chats",
        SubTitle: "Chats and their settings will be imported from a JSON file",
        Action: "Import",
        Confirm: "Are you sure you want to import all chats?",
      },           
      ExportSettings: {
        Title: "Export All Settings",
        SubTitle: "All Settings will be exported into a JSON file",
        Action: "Export",
        Confirm: "Are you sure you want to export all global config settings?",
      },
      ImportSettings: {
