...
const cn = {
  ...
  **回答：** 是的，本站一直是免费使用的！
  ...
  卡顿或无响应？可能是用户量太大， **[点这里获得独立 KEY 使用,速度会极大提升](https://www.mofaxi.cn/shop/17.html)**
  ...
  Store: {
    DefaultTopic: "新的聊天",
    BotHello: `欢迎使用魔法ChatGPT，点击左下角[设置](/#/settings)按钮输入访问密码666888即可免费使用。
