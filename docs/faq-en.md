...
Please refer to: [#371](https://github.com/ChatGPT-Next-Web/ChatGPT-Next-Web/issues/371)

## Why is my Token consumed so fast?

> Related discussion: [#518](https://github.com/ChatGPT-Next-Web/ChatGPT-Next-Web/issues/518)
